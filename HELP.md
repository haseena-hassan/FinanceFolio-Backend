...
* The original package name 'com.haseena-java-apps.finance-tracker-backend' is invalid and this project uses 'com.haseenajavaapps.financetrackerbackend' instead.
